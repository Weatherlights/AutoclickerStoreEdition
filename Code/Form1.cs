...
namespace AutoClicker
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            OpenBrowser("https://sourceforge.net/p/orphamielautoclicker/tickets/");
        }

        private void bugReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OpenBrowser("https://www.microsoft.com/p/autoclicker-powered-by-weatherlightscom/9p929t9p1j1m");
        }
